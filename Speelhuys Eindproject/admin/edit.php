...
<body>
    ...
    <div class="container d-flex justify-content-center">
        <div class="card col-md-6">
            <h3 class="text-center mb-4">Product Aanpassen</h3>
            <form method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="name" class="form-label">Naam</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Product naam" required value="<?= $set->name; ?>">
                </div>
                <div class="mb-3">
                    <label for="description" class="form-label">Beschrijving</label>
                    <input type="text" class="form-control" id="description" name="description" placeholder="Beschrijving" required value="<?= $set->description; ?>">
                </div>
                <div class="mb-3">
                    <label for="brandid" class="form-label">Brand ID</label>
                    <input type="text" class="form-control" id="brandid" name="brandid" placeholder="Brand ID" required value="<?= $set->brandid; ?>">
                </div>
                <div class="mb-3">
                    <label for="themeid" class="form-label">Theme ID</label>
                    <input type="text" class="form-control" id="themeid" name="themeid" placeholder="Theme ID" required value="<?= $set->themeid; ?>">
                </div>
                <div class="mb-3">
                    <label for="price" class="form-label">Prijs</label>
                    <input type="text" class="form-control" id="price" name="price" placeholder="Prijs" required value="<?= $set->price; ?>">
                </div>
                <div class="mb-3">
                    <label for="image" class="form-label">Afbeelding</label>
                    <input type="file" class="form-control" id="image" name="image" required value="<?= $set->image; ?>">
                </div>
                <div class="mb-3">
                    <label for="age" class="form-label">Leeftijd</label>
                    <input type="text" class="form-control" id="age" name="age" placeholder="Aanbevolen leeftijd" required value="<?= $set->age; ?>">
                </div>
                <div class="mb-3">
                    <label for="pieces" class="form-label">Stuks</label>
                    <input type="text" class="form-control" id="pieces" name="pieces" placeholder="Aantal stuks" required value="<?= $set->pieces; ?>">
                </div>
                <div class="mb-3">
                    <label for="stock" class="form-label">Voorraad</label>
                    <input type="text" class="form-control" id="stock" name="stock" placeholder="Beschikbare voorraad" required value="<?= $set->stock; ?>">
                </div>
